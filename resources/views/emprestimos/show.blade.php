        ...
        <div class="card shadow-sm mb-4">
            ...
            <div class="card-body">
                ...
                @if($emprestimo->saldo > 0)
                    @include('partials.whatsapp-button', ['link' => $emprestimo->cliente->linkWhatsapp(\App\Support\MensagemCobranca::gerar('geral', $emprestimo->saldo, $emprestimo->cliente->nome, $emprestimo->parcelas)), 'label' => 'Cobrar pelo WhatsApp'])
                @endif
            </div>
        </div>
    </div>
